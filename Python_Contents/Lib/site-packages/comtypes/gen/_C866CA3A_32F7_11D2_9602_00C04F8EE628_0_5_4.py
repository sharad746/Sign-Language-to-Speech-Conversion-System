...
__all__ = [
    'DISPID_SVGetAudioOutputs', 'SP_VISEME_15', 'SPINTERFERENCE',
    'SpeechRuleState', 'SPEVENT', 'DISPID_SLPType',
    'ISequentialStream', 'ISpeechCustomStream', 'ISpEventSink',
    'DISPID_SGRsDynamic', 'DISPID_SpeechObjectTokenCategory',
    'SpeechGrammarWordType', 'SPSHT_EMAIL', 'DISPID_SpeechFileStream',
    'SAFTCCITT_ALaw_8kHzMono', 'SPBINARYGRAMMAR', 'ISpeechLexicon',
    'DISPID_SRGCmdLoadFromFile', 'SGPronounciation',
    'ISpeechPhraseRule', 'SAFTCCITT_ALaw_44kHzStereo',
    'ISpeechBaseStream', 'SpeechEngineProperties',
    'DISPID_SVEPhoneme', 'ISpNotifyTranslator',
    'SPEI_END_INPUT_STREAM', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SLWPronunciations', 'SPFM_CREATE_ALWAYS', 'SPXRO_SML',
    'SRTReSent', 'ISpShortcut', 'SECFIgnoreKanaType',
    'DISPID_SVEViseme', 'SPCONTEXTSTATE', 'SGLexical',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SRERecognition', 'SVP_20',
    'DISPID_SVSPhonemeId', 'SGRSTTWord', 'SAFT16kHz16BitStereo',
    'ISpProperties', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRCRetainedAudioFormat', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFTGSM610_11kHzMono', 'SPADAPTATIONRELEVANCE', 'SPPS_RESERVED1',
    'DISPID_SRCEEndStream', 'ISpeechPhraseReplacements',
    'ISpeechFileStream', 'DISPID_SDKCreateKey',
    'DISPID_SpeechMMSysAudio', 'eLEXTYPE_PRIVATE10',
    'DISPID_SRGIsPronounceable', 'DISPID_SVEAudioLevel',
    'SPSEMANTICERRORINFO', 'SAFT44kHz8BitMono', 'ISpRecoContext2',
    'ISpeechPhraseElement', 'SDTRule', 'SPINTERFERENCE_TOOLOUD',
    'SpMMAudioIn', 'SPGS_EXCLUSIVE', 'DISPID_SRCERecognition',
    'ISpeechVoiceStatus', 'DISPID_SOTRemove', 'SVP_16',
    'DISPID_SpeechVoice', 'SPINTERFERENCE_TOOFAST', 'SPVPRI_ALERT',
    'DISPID_SPRuleConfidence', 'SP_VISEME_14', 'eLEXTYPE_PRIVATE4',
    'DISPID_SpeechRecoContextEvents', 'SpLexicon', 'SBOPause',
    'SECFNoSpecialChars', 'SpeechAudioProperties',
    'SpPhoneticAlphabetConverter', 'DISPID_SOTCGetDataKey',
    'SpeechAllElements', 'DISPID_SVEBookmark', 'SVP_10',
    'DISPID_SRCESoundStart', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SWFEBlockAlign', 'SVP_14', 'SAFTNoAssignedFormat',
    'DISPID_SAFGuid', 'SAFTADPCM_44kHzStereo', 'DISPID_SGRAddState',
    'SP_VISEME_5', 'SPVISEMES', 'SAFTText', 'DISPID_SPRulesItem',
    'SFTSREngine', 'SRSActiveAlways', 'eLEXTYPE_RESERVED7',
    'DISPID_SPEs_NewEnum', 'ISpeechGrammarRules',
    'DISPID_SPCPhoneToId', 'ISpMMSysAudio', 'DISPID_SMSAMMHandle',
    'SpeechAudioFormatGUIDWave', 'DISPID_SRSAudioStatus',
    'SpeechAudioFormatType', 'SREStreamStart',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRSTransitions',
    'DISPID_SRGCmdSetRuleState', 'SPSERIALIZEDRESULT',
    'SPEI_ADAPTATION', 'ISpStreamFormatConverter', 'ISpRecoContext',
    'SVP_1', 'DISPID_SPRDisplayAttributes', 'ISpeechGrammarRuleState',
    'DISPID_SpeechPhraseReplacements', 'SITooFast',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SGRsFindRule', 'eLEXTYPE_USER',
    'SpeechLexiconType', 'DISPID_SVGetProfiles', 'eLEXTYPE_RESERVED8',
    'SpVoice', 'SRTAutopause', 'DISPID_SOTDisplayUI',
    'SpeechGrammarTagWildcard', 'SREFalseRecognition',
    'DISPID_SVPause', 'SPAR_Unknown', 'DISPID_SpeechGrammarRuleState',
    'SPSHORTCUTTYPE', 'SpeechVoicePriority', 'SVP_21',
    'SPRST_ACTIVE_ALWAYS', 'STCAll', 'SAFT16kHz8BitMono',
    'DISPID_SRProfile', 'DISPID_SRCEventInterests', 'DISPID_SPPsItem',
    'SPPS_Interjection', 'SRSEDone', 'DISPID_SCSBaseStream',
    'eLEXTYPE_PRIVATE18', 'DISPID_SRSetPropertyNumber',
    'DISPID_SFSClose', 'SVEPhoneme', 'SPWT_DISPLAY', 'SPWF_SRENGINE',
    'SPEI_RESERVED3', 'DISPID_SRCState', 'SPINTERFERENCE_NONE',
    'DISPID_SPACommit', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SREStreamEnd', 'DISPID_SWFEChannels',
    'DISPID_SVSLastStreamNumberQueued', 'SRSEIsSpeaking',
    'DISPID_SPRNumberOfElements', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRRAudio', 'SpeechRecoContextState',
    'SWPUnknownWordUnpronounceable', 'SAFT48kHz8BitStereo',
    'ISpObjectTokenCategory', 'SPWORDPRONUNCIATION',
    'SPPHRASEELEMENT', 'SpeechCategoryAudioOut',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPFM_NUM_MODES',
    'DISPID_SOTCSetId', 'ISpeechGrammarRuleStateTransitions',
    'eLEXTYPE_PRIVATE11', 'SPEI_TTS_PRIVATE', 'DISPID_SDKDeleteValue',
    'DISPID_SVResume', 'DISPID_SpeechLexiconProns', 'DISPID_SRState',
    'ISpeechPhraseElements', 'SpeechRunState',
    'DISPID_SLGetPronunciations', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRCreateRecoContext', 'eLEXTYPE_PRIVATE12',
    'STCInprocServer', 'SP_VISEME_2', 'DISPID_SPRuleId',
    'SpeechVisemeType', 'SVPNormal', 'DISPID_SPAStartElementInResult',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_RESERVED4',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SAFT12kHz8BitMono',
    'DISPID_SPPFirstElement', 'ISpeechGrammarRule', 'STCLocalServer',
    'SP_VISEME_20', 'DISPID_SRSCurrentStreamNumber', 'SPSVerb',
    'SAFT32kHz16BitMono', 'DISPID_SRRSetTextFeedback',
    'DISPID_SPIGrammarId', 'DISPID_SRRPhraseInfo',
    'DISPID_SLPPartOfSpeech', 'SDA_No_Trailing_Space',
    'ISpeechPhraseInfo', 'DISPID_SVGetAudioInputs',
    'SAFT8kHz16BitStereo', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SRGetFormat', 'ISpRecognizer3', 'SVSFlagsAsync',
    'DISPID_SRCCreateResultFromMemory', 'SpUnCompressedLexicon',
    'ISpLexicon', 'SDTPronunciation', 'SPEI_SR_RETAINEDAUDIO',
    'SASPause', 'SPSSuppressWord', 'eWORDTYPE_DELETED',
    'SAFT48kHz16BitStereo', 'SVEBookmark', 'SGDisplay',
    'SAFT48kHz16BitMono', 'DISPID_SPIElements', 'SECFIgnoreWidth',
    'DISPID_SRCEStartStream', 'DISPID_SBSSeek', 'SDTAlternates',
    'DISPID_SpeechPhoneConverter', 'SPLO_STATIC',
    'DISPID_SRRTTickCount', 'SpMMAudioOut', 'SPEI_REQUEST_UI',
    'DISPID_SLPs_NewEnum', 'DISPID_SDKEnumValues',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPEI_RECOGNITION',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SAFTCCITT_ALaw_11kHzStereo', 'SREInterference', 'DISPID_SRGId',
    'DISPID_SDKGetStringValue', 'SpeechTokenKeyAttributes',
    'SWPUnknownWordPronounceable', 'DISPID_SRGSetWordSequenceData',
    'SAFT16kHz8BitStereo', 'DISPID_SRGDictationSetState',
    'DISPID_SFSOpen', 'DISPID_SGRSTNextState',
    'DISPID_SRSClsidEngine', 'ISpObjectToken',
    'DISPID_SpeechRecognizer', 'DISPID_SPERequiredConfidence',
    'DISPID_SpeechPhraseBuilder', 'eLEXTYPE_PRIVATE2',
    'Speech_Max_Word_Length', 'SP_VISEME_1', 'SpInprocRecognizer',
    'DISPID_SPPChildren', 'SPSLMA', 'DISPID_SpeechPhraseProperties',
    'SECFDefault', 'DISPID_SRGSetTextSelection',
    'DISPID_SVESentenceBoundary', 'DISPID_SpeechDataKey',
    'eLEXTYPE_PRIVATE19', 'SPWT_PRONUNCIATION', 'SPAUDIOSTATE',
    'SpeechTokenShellFolder',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPIRule',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechVoiceSpeakFlags',
    'DISPID_SVSLastBookmark', 'DISPID_SVEWord', 'STSF_FlagCreate',
    'SpMMAudioEnum', '_ISpeechRecoContextEvents', 'SAFT24kHz8BitMono',
    'ISpRecoCategory', 'DISPID_SPEAudioSizeTime', 'ISpeechAudio',
    'DISPID_SGRSTWeight', 'SRAONone', 'SAFT22kHz8BitMono',
    'SAFTGSM610_22kHzMono', 'DISPID_SPEAudioSizeBytes', 'SVSFNLPMask',
    'DISPID_SpeechObjectToken', 'DISPID_SPIGetDisplayAttributes',
    'SPRECORESULTTIMES', 'SAFT48kHz8BitMono', 'DISPID_SPCIdToPhone',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SLPSymbolic', 'DISPID_SOTGetAttribute',
    'DISPID_SPRsCount', 'DISPID_SPPConfidence',
    'ISpeechPhraseAlternates', 'DISPID_SDKDeleteKey',
    'DISPID_SPAsItem', 'DISPID_SpeechVoiceStatus', 'SPPS_Modifier',
    'ISpGrammarBuilder', 'SVSFDefault', 'DISPID_SAFSetWaveFormatEx',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SDKSetLongValue',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPDKL_LocalMachine',
    'SAFTCCITT_uLaw_11kHzMono', 'SGSEnabled',
    'DISPID_SRCEInterference', 'SPSERIALIZEDPHRASE',
    'ISpeechRecoResult', 'SGRSTTTextBuffer',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SABufferInfo',
    'SPCT_COMMAND', 'DISPIDSPRG', 'SDTProperty', 'SAFT11kHz8BitMono',
    'DISPID_SpeechLexiconWord',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SPAS_CLOSED',
    'SPEI_SR_PRIVATE', 'SPEVENTSOURCEINFO', 'SpeechDiscardType',
    'DISPID_SGRsAdd', 'SAFT11kHz8BitStereo', 'SpSharedRecoContext',
    'SpeechAudioState', 'DISPID_SGRsCommit',
    'SpeechDisplayAttributes', 'DISPID_SABIMinNotification',
    'ISpeechPhraseProperties', 'DISPID_SABIEventBias',
    'ISpObjectWithToken', 'ISpeechRecoResultDispatch',
    'DISPIDSPTSI_ActiveOffset', 'ISpeechVoice',
    'DISPID_SVSLastBookmarkId', '_SPAUDIOSTATE', 'SPSNotOverriden',
    'SVSFVoiceMask', 'SAFTADPCM_11kHzStereo', 'DISPID_SPEsItem',
    'SPAR_Medium', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SpeechPhraseProperty', 'SPPS_Function', 'SPWORDLIST',
    'SVSFIsFilename', 'DISPID_SASState', 'SGRSTTEpsilon',
    'DISPID_SPAsCount', 'ISpeechGrammarRuleStateTransition',
    'ISpeechAudioStatus', 'SLTUser', 'SpeechDataKeyLocation',
    'DISPID_SLPLangId', 'DISPID_SpeechRecognizerStatus', 'SVP_4',
    'DISPID_SPRText', 'DISPID_SRRecognizer', 'WAVEFORMATEX',
    'DISPID_SRRDiscardResultInfo', 'SAFTADPCM_11kHzMono', 'SVP_6',
    'DISPID_SRGetRecognizers', 'DISPID_SRRSpeakAudio',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRInitialState',
    'SpeechPropertyComplexResponseSpeed',
    'SDA_Consume_Leading_Spaces', 'eLEXTYPE_APP', 'SPPS_Noncontent',
    'SPEI_VOICE_CHANGE', 'SPEI_START_INPUT_STREAM',
    'DISPID_SRCCmdMaxAlternates', 'Speech_StreamPos_Asap',
    'SPEI_PHONEME', 'SPEI_RESERVED1', 'SPWORDPRONOUNCEABLE',
    'SPSTREAMFORMATTYPE', 'SREPrivate', 'SDKLCurrentConfig',
    'DISPID_SAEventHandle', 'SP_VISEME_21', 'DISPID_SLWWord',
    'SP_VISEME_0', 'DISPID_SVStatus', 'DISPID_SRCEPhraseStart',
    'DISPID_SGRSAddWordTransition', 'SVP_17',
    'DISPID_SpeechObjectTokens', 'DISPID_SRRAudioFormat', 'IStream',
    'DISPID_SpeechLexicon', 'SVSFParseSsml', 'SPVPRIORITY',
    'DISPID_SVAudioOutputStream', 'DISPID_SRCEBookmark',
    'SPDKL_CurrentConfig', 'eLEXTYPE_PRIVATE14',
    'ISpeechAudioBufferInfo', 'SPBO_TIME_UNITS',
    'ISpeechObjectTokens', 'DISPID_SGRSTText', 'SPAR_High',
    'DISPID_SABufferNotifySize', 'SPCS_DISABLED', 'SDTReplacement',
    'ISpeechPhraseAlternate', 'ISpeechPhraseReplacement',
    'SRADefaultToActive', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpResourceManager', 'SPXRO_Alternates_SML', 'SPPROPERTYINFO',
    'DISPID_SpeechLexiconPronunciation', 'SLODynamic', 'SVP_0',
    'DISPID_SRRAlternates', 'DISPID_SPISaveToMemory',
    'SREPhraseStart', 'eLEXTYPE_PRIVATE20', 'SRSInactive',
    'DISPID_SRCRecognizer', 'SAFT44kHz16BitStereo', 'SVEViseme',
    'DISPID_SRCEEnginePrivate', 'SAFTCCITT_uLaw_22kHzMono',
    'SP_VISEME_18', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRGRules', 'DISPID_SOTs_NewEnum',
    'SGDSActiveWithAutoPause', 'SSTTTextBuffer',
    'DISPID_SVEVoiceChange', 'SSFMOpenReadWrite',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SMSSetData',
    'DISPID_SPRuleName', 'DISPID_SOTCreateInstance',
    'SpeechTokenKeyUI', 'SPPS_Noun', 'DISPID_SLGenerationId',
    'SPWORDTYPE', 'DISPID_SASCurrentDevicePosition',
    'eLEXTYPE_VENDORLEXICON', 'SVSFNLPSpeakPunc', 'SPEI_HYPOTHESIS',
    'DISPID_SRCRequestedUIType', 'DISPID_SGRSTPropertyName',
    'DISPID_SLWType', 'SpeechTokenIdUserLexicon', 'SVP_5',
    'SRAImport', 'SPCATEGORYTYPE', 'DISPID_SPRuleEngineConfidence',
    'IInternetSecurityManager', 'SRSActive', 'DISPID_SRIsShared',
    'SPSEMANTICFORMAT', 'DISPID_SpeechWaveFormatEx',
    'SPEI_PHRASE_START', 'SGRSTTRule', 'DISPID_SLPsCount',
    'SpWaveFormatEx', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SPEActualConfidence', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SPAs_NewEnum', 'DISPID_SDKSetStringValue', 'SPSNoun',
    'ISpeechLexiconPronunciations', 'SAFT24kHz8BitStereo',
    'SECNormalConfidence', 'SpCustomStream', 'SVF_Stressed',
    'SGDSInactive', 'DISPIDSPTSI', 'DISPID_SpeechRecoContext',
    'DISPID_SRCEHypothesis', 'SpeechAudioVolume',
    'SpeechGrammarTagUnlimitedDictation', 'Speech_Max_Pron_Length',
    'DISPID_SBSFormat', 'DISPID_SVSpeakStream', 'SPGRAMMARWORDTYPE',
    'ISpeechObjectToken', 'SGRSTTDictation',
    'DISPID_SPANumberOfElementsInResult', 'eWORDTYPE_ADDED',
    'DISPID_SDKGetBinaryValue', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpeechPhraseRules', 'DISPID_SRCResume', 'DISPID_SRCPause',
    'SWTDeleted', 'SPRST_INACTIVE', 'SSFMCreateForWrite',
    'SPSHT_NotOverriden', 'SVP_15', 'SAFT8kHz16BitMono',
    'SAFT11kHz16BitStereo', 'SP_VISEME_4', 'SSTTWildcard',
    'SPTEXTSELECTIONINFO', 'SAFTADPCM_8kHzMono', 'SPLO_DYNAMIC',
    'SVEAudioLevel', 'DISPID_SASFreeBufferSpace', 'SPEI_MAX_SR',
    'SAFT32kHz16BitStereo', 'DISPID_SRSNumberOfActiveRules',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVSFParseAutodetect',
    'SRTSMLTimeout', 'SSSPTRelativeToStart', 'DISPID_SRIsUISupported',
    'DISPID_SVSCurrentStreamNumber', 'ISpeechWaveFormatEx',
    'DISPID_SVVoice', 'SAFTADPCM_44kHzMono',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SGRSRule',
    'DISPID_SRRTStreamTime', 'DISPID_SOTRemoveStorageFileName',
    'SREPropertyNumChange', 'DISPID_SPIAudioStreamPosition',
    'UINT_PTR', 'SSFMOpenForRead', 'DISPID_SpeechMemoryStream',
    '_RemotableHandle', 'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SAStatus',
    'SpeechRuleAttributes', 'SRTExtendableParse', 'DISPID_SAFType',
    'DISPID_SRCERequestUI', 'SP_VISEME_11', 'DISPID_SGRs_NewEnum',
    'SECHighConfidence', 'DISPID_SMSGetData', 'ISpeechLexiconWords',
    'ISpeechMemoryStream', 'DISPID_SGRName', 'SPEI_START_SR_STREAM',
    'SAFT24kHz16BitMono', 'DISPID_SPRs_NewEnum', 'SASClosed',
    'DISPID_SpeechVoiceEvent', 'SPDKL_DefaultLocation',
    'SpeechUserTraining', 'DISPID_SpeechRecoResultTimes',
    'SpeechPartOfSpeech', 'SAFT22kHz8BitStereo',
    'DISPID_SPPEngineConfidence', 'SpeechWordType',
    'SpeechCategoryAppLexicons', 'DISPID_SAVolume', 'SPGS_ENABLED',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SRAudioInput',
    'SPRECOGNIZERSTATUS', 'DISPID_SRDisplayUI',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpPhoneticAlphabetSelection',
    'DISPID_SPIProperties', 'SpeechStreamSeekPositionType',
    'SpObjectToken', 'SP_VISEME_10', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPIEngineId', 'DISPID_SOTsItem', 'SVP_13',
    'SPPS_RESERVED3', 'SDKLCurrentUser', 'eLEXTYPE_PRIVATE8',
    'SPSMF_UPS', 'SpSharedRecognizer', 'DISPID_SVPriority',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPPId',
    'SPEI_RESERVED2', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SWFEBitsPerSample', 'DISPID_SPPValue',
    'DISPID_SpeechAudioFormat', 'DISPID_SGRSAddSpecialTransition',
    'SAFTGSM610_44kHzMono', 'DISPID_SRGCmdLoadFromResource',
    'ISpeechRecoContext', 'DISPID_SPEPronunciation', 'SRATopLevel',
    'SPAS_PAUSE', 'DISPID_SpeechPhraseInfo', 'SPEI_FALSE_RECOGNITION',
    'SECFIgnoreCase', 'SPWF_INPUT', 'SPVOICESTATUS', 'SPPS_Verb',
    'SPEI_RECO_STATE_CHANGE', 'ISpRecognizer',
    'SpStreamFormatConverter', 'ISpAudio',
    'DISPID_SLAddPronunciation', 'DISPID_SVEventInterests',
    'SpeechGrammarTagDictation', 'SpeechCategoryAudioIn', 'SINone',
    'SAFTCCITT_ALaw_11kHzMono', 'SREAudioLevel',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPPs_NewEnum',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCSetAdaptationData',
    'SPPARTOFSPEECH', 'SpAudioFormat', 'SPAS_RUN',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SVSkip',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SP_VISEME_13',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SpeechPhraseReplacement',
    'eLEXTYPE_PRIVATE17', 'SPGS_DISABLED', 'SAFT16kHz16BitMono',
    'tagSTATSTG', 'SRADynamic', 'SGRSTTWildcard', 'SPPHRASE',
    'SpNotifyTranslator', 'IEnumSpObjectTokens',
    'DISPID_SLGetGenerationChange', 'DISPID_SRGDictationUnload',
    'DISPID_SLGetWords', 'DISPID_SpeechBaseStream',
    'SPEI_TTS_AUDIO_LEVEL', 'eLEXTYPE_PRIVATE16',
    'SVESentenceBoundary', 'SRCS_Enabled', 'DISPID_SGRAddResource',
    'DISPID_SGRsCount', 'SpeechRegistryLocalMachineRoot',
    'SPSHORTCUTPAIR', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SpeechRecoResult', 'SWTAdded',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPRules_NewEnum',
    'SpeechStreamFileMode', 'eLEXTYPE_PRIVATE3', 'DISPID_SVSpeak',
    'DISPID_SpeechGrammarRule', 'SPAUDIOSTATUS', 'DISPID_SPRsItem',
    'ISpPhrase', 'DISPID_SRRTimes', 'SpeechFormatType', 'SPAR_Low',
    'SLOStatic', 'SPAO_RETAIN_AUDIO', 'SASRun', 'SAFT44kHz16BitMono',
    'SPCS_ENABLED', 'DISPID_SpeechPhraseRule', 'SDTDisplayText',
    'SPEI_SR_BOOKMARK', 'DISPID_SpeechPhraseAlternate', 'SP_VISEME_8',
    'SREAdaptation', 'DISPID_SOTCategory', 'DISPIDSPTSI_ActiveLength',
    'SRAExport', 'SPPS_Unknown', 'IInternetSecurityMgrSite',
    'DISPID_SVSInputWordLength', 'DISPID_SPIReplacements',
    'SPWT_LEXICAL', 'SAFT44kHz8BitStereo', 'SpCompressedLexicon',
    'SPAUDIOOPTIONS', 'SAFT22kHz16BitMono', 'SpShortcut',
    'ISpeechPhoneConverter', 'SpeechRecognizerState',
    'ISpeechLexiconWord', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRCEAudioLevel', 'SRESoundEnd', 'SPRS_INACTIVE',
    'ISpeechResourceLoader', 'SpeechPropertyAdaptationOn',
    'SpeechLoadOption', 'SPRULESTATE', 'SPEI_TTS_BOOKMARK',
    'ISpeechDataKey', 'ISpNotifySource', 'SAFT12kHz16BitStereo',
    'tagSPPROPERTYINFO', 'SAFTGSM610_8kHzMono',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRCVoice',
    'SpeechGrammarState', 'ISpeechPhraseProperty',
    'SpeechEmulationCompareFlags', 'SpeechTokenKeyFiles',
    'ISpRecoResult', 'ISpPhoneConverter', 'DISPID_SpeechLexiconWords',
    'SPSUnknown', 'DISPID_SDKEnumKeys', 'DISPID_SDKSetBinaryValue',
    'SGDSActiveUserDelimited', 'DISPID_SRRRecoContext', 'SVPAlert',
    'SPEI_VISEME', 'DISPID_SRSetPropertyString', 'ISpStream',
    'SPEI_PROPERTY_NUM_CHANGE', 'SVEEndInputStream',
    'SPRST_NUM_STATES', 'eLEXTYPE_RESERVED6',
    'DISPID_SWFEAvgBytesPerSec', 'SVP_3', 'SPFM_OPEN_READWRITE',
    'SAFT32kHz8BitMono', 'DISPID_SOTSetId', 'SPCT_DICTATION',
    'SPFILEMODE', 'DISPID_SBSRead', 'DISPID_SPEsCount', 'SPBO_AHEAD',
    'SAFTADPCM_22kHzMono', 'SPPS_SuppressWord', 'ISpEventSource',
    'SAFTCCITT_ALaw_22kHzStereo', 'SITooSlow',
    'SDA_One_Trailing_Space', 'DISPID_SGRSTPropertyId',
    'DISPID_SBSWrite', 'DISPID_SpeechGrammarRules', 'SPRULE',
    'DISPID_SRGReset', 'DISPID_SOTId', 'SVF_None',
    'DISPID_SPIAudioSizeTime', 'SpeechMicTraining',
    'SAFT8kHz8BitMono', 'ISpeechMMSysAudio', 'DISPID_SLWsItem',
    'SPXMLRESULTOPTIONS', 'SAFTDefault', '__MIDL_IWinTypes_0009',
    'SVEWordBoundary', 'SpStream', 'DISPID_SpeechCustomStream',
    'DISPID_SGRsCommitAndSave', 'eLEXTYPE_PRIVATE6',
    'DISPID_SVVolume', 'DISPID_SRCRetainedAudio',
    'DISPID_SLRemovePronunciation', 'DISPID_SpeechPhraseElements',
    'SDA_Two_Trailing_Spaces', 'SVSFUnusedFlags',
    'SPPHRASEREPLACEMENT', 'DISPID_SPIGetText',
    'DISPID_SRRGetXMLErrorInfo', 'SPVPRI_NORMAL',
    'DISPID_SREmulateRecognition', 'ISpeechPhraseInfoBuilder',
    'SRERequestUI', 'DISPID_SRCCreateGrammar', 'SpeechAddRemoveWord',
    'DISPID_SVRate', 'SPSInterjection', 'SpeechEngineConfidence',
    'SpMemoryStream', 'DISPID_SPIStartTime', 'SPPS_RESERVED2',
    'SLTApp', 'DISPIDSPTSI_SelectionOffset', 'SVEPrivate',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRCEAdaptation',
    'DISPID_SpeechPhraseRules', 'eLEXTYPE_PRIVATE5',
    'eLEXTYPE_PRIVATE15', 'SSFMCreate', 'SPAS_STOP',
    'DISPID_SGRSTType', 'SVP_11', 'DISPID_SOTCDefault',
    'SAFT8kHz8BitStereo', 'SPSModifier', 'DISPID_SDKOpenKey',
    'SPEI_MIN_TTS', 'eLEXTYPE_USER_SHORTCUT', 'eLEXTYPE_PRIVATE9',
    'DISPID_SLPPhoneIds', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SOTCId', 'DISPID_SVSInputWordPosition', 'DISPID_SGRId',
    'SPEI_WORD_BOUNDARY', 'SPEI_RESERVED6', 'DISPID_SASetState',
    'DISPID_SLWs_NewEnum', 'DISPID_SOTGetDescription',
    'DISPID_SOTGetStorageFileName', 'SDTLexicalForm', 'ISpPhraseAlt',
    'SRCS_Disabled', 'SVP_2', 'SVSFParseSapi', 'ISpResourceManager',
    'ISpeechTextSelectionInformation', 'DISPID_SOTCEnumerateTokens',
    'SPFM_CREATE', 'SITooQuiet', 'ISpeechRecognizer', 'SPVPRI_OVER',
    'SRERecoOtherContext', 'DISPID_SRCESoundEnd',
    'DISPID_SADefaultFormat', 'ISpeechXMLRecoResult',
    'SPPS_RESERVED4', 'DISPID_SVEEnginePrivate', 'SPEI_MIN_SR',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SLWsCount',
    'DISPID_SMSALineId', 'SPBO_PAUSE', 'DISPID_SRRGetXMLResult',
    'DISPID_SPRFirstElement', 'DISPID_SRGCommit', 'STCInprocHandler',
    'SPGRAMMARSTATE', 'SDTAudio', 'SpeechDictationTopicSpelling',
    'DISPID_SVAudioOutput', 'DISPID_SRCVoicePurgeEvent', 'SPAO_NONE',
    'DISPID_SRGRecoContext', 'ISpRecoGrammar2', 'SDKLDefaultLocation',
    'DISPID_SOTIsUISupported', 'eLEXTYPE_RESERVED10', 'ISpDataKey',
    'DISPID_SRGetPropertyNumber', 'SpeechCategoryPhoneConverters',
    'SVSFParseMask', 'DISPID_SWFESamplesPerSec', 'SP_VISEME_12',
    'SRTEmulated', 'DISPID_SPPParent', 'SpeechCategoryRecognizers',
    'ISpPhoneticAlphabetConverter', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SLPsItem', 'DISPID_SGRClear', 'SP_VISEME_16',
    'ISpeechRecoGrammar', 'DISPID_SpeechRecoResult2',
    'SpeechPropertyResponseSpeed', 'SPAUDIOBUFFERINFO',
    'SPINTERFERENCE_NOISE', 'SECLowConfidence', 'SVEStartInputStream',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRGCmdLoadFromObject',
    'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'ISpNotifySink',
    'DISPID_SABIBufferSize', 'SRARoot', 'DISPID_SDKGetlongValue',
    'SpFileStream', 'DISPID_SRCBookmark', 'DISPID_SRRTLength',
    'SpPhoneConverter', 'ISpeechRecoResult2', 'SpeechRecognitionType',
    'DISPID_SRAudioInputStream', 'SPEI_MAX_TTS', 'SPSHORTCUTPAIRLIST',
    'DISPID_SpeechAudio', 'SVP_7', 'DISPID_SVEStreamStart',
    'SWPKnownWordPronounceable', 'SPBO_NONE', 'SRAORetainAudio',
    'SPPHRASEPROPERTY', 'SREAllEvents', 'SVP_12', 'SPBOOKMARKOPTIONS',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRRSaveToMemory', 'IEnumString',
    'DISPID_SOTMatchesAttributes', 'SVSFIsNotXML', 'SVP_19',
    'SPSFunction', 'DISPID_SOTDataKey', 'SAFT12kHz8BitStereo',
    'ISpStreamFormat', 'DISPID_SGRSTsItem', 'SRTStandard',
    'DISPID_SVAlertBoundary', 'SPLOADOPTIONS', 'SpPhraseInfoBuilder',
    'SVF_Emphasis', 'DISPID_SRSSupportedLanguages',
    'ISpeechRecoResultTimes', 'STSF_CommonAppData', 'SPPHRASERULE',
    'SBONone', '_ISpeechVoiceEvents', 'SDKLLocalMachine',
    'SAFT12kHz16BitMono', 'SVEVoiceChange', 'DISPID_SWFEFormatTag',
    'DISPID_SPILanguageId', 'SpeechTokenContext',
    'DISPID_SPEEngineConfidence', 'SITooLoud', 'SPSHT_Unknown',
    'SAFT22kHz16BitStereo', 'SINoSignal',
    'SpeechCategoryRecoProfiles', 'DISPID_SRGState',
    'ISpeechObjectTokenCategory', 'SSSPTRelativeToEnd',
    'DISPID_SVIsUISupported', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SPPName', 'SPEI_RESERVED5', 'SVEAllEvents',
    'SPWORDPRONUNCIATIONLIST', 'SpeechBookmarkOptions',
    'DISPID_SRGCmdSetRuleIdState', 'SDTAll', 'SpeechInterference',
    'SPEI_INTERFERENCE', 'DISPID_SWFEExtraData', 'SVP_8',
    'ISpeechLexiconPronunciation', 'SFTInput', 'SPSHT_OTHER',
    'DISPID_SGRAttributes', 'DISPID_SpeechAudioStatus',
    'ISpeechRecognizerStatus', 'SAFTNonStandardFormat',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPAPhraseInfo',
    'SAFTADPCM_8kHzStereo', 'DISPID_SPEDisplayText',
    'SAFT24kHz16BitStereo', 'DISPID_SPRulesCount',
    'SpObjectTokenCategory', 'DISPID_SVWaitUntilDone',
    'SPFM_OPEN_READONLY', 'SpeechRetainedAudioOptions',
    'SP_VISEME_19', 'SPINTERFERENCE_NOSIGNAL',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFTCCITT_ALaw_44kHzMono', 'SSTTDictation',
    'SAFTExtendedAudioFormat', 'SpNullPhoneConverter',
    'eLEXTYPE_PRIVATE7', 'SpeechCategoryVoices', 'SPRST_ACTIVE',
    'DISPID_SPEAudioStreamOffset', 'SpeechVoiceEvents', 'SP_VISEME_9',
    'DISPID_SVSInputSentenceLength', 'ISpXMLRecoResult',
    'SpeechSpecialTransitionType', 'SGSDisabled',
    'SREPropertyStringChange', 'DISPID_SPPBRestorePhraseFromMemory',
    'Speech_Default_Weight', 'DISPID_SVSVisemeId', 'SVSFIsXML',
    'SPPS_LMA', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SVSyncronousSpeakTimeout', 'SRESoundStart',
    'STSF_LocalAppData', 'SpeechRegistryUserRoot', 'SPRECOSTATE',
    'SPEI_UNDEFINED', 'SINoise', 'DISPID_SPEDisplayAttributes',
    'DISPID_SVGetVoices', 'DISPID_SRGetPropertyString',
    'ISpRecoGrammar', 'ISpVoice', 'SGLexicalNoSpecialChars',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpTextSelectionInformation', 'DISPID_SRStatus',
    'SECFEmulateResult', 'SVPOver', 'SpeechAudioFormatGUIDText',
    'DISPIDSPTSI_SelectionLength', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SVSRunningState', 'LONG_PTR', 'SP_VISEME_17',
    'SPRECOCONTEXTSTATUS', 'SPEI_SR_AUDIO_LEVEL',
    'SpeechPropertyHighConfidenceThreshold', 'SpeechVisemeFeature',
    'SpeechWordPronounceable', 'DISPID_SPRuleChildren',
    'DISPID_SpeechPhraseElement', 'SAFT11kHz16BitMono',
    'DISPID_SPRuleFirstElement', 'ISpeechAudioFormat',
    'DISPID_SOTsCount', 'SASStop', 'SVSFPurgeBeforeSpeak',
    'ISpRecognizer2', 'DISPID_SMSADeviceId',
    'DISPID_SASNonBlockingIO', 'DISPID_SGRSTRule',
    'DISPID_SASCurrentSeekPosition', 'SVP_9', 'DISPID_SPRuleParent',
    'SREStateChange', 'DISPID_SLWLangId',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPCLangId',
    'SP_VISEME_6', 'SpeechTokenValueCLSID', 'SPWORD',
    'DISPID_SRCEPropertyStringChange', 'SPRS_ACTIVE',
    'SPDKL_CurrentUser', 'SVSFPersistXML', 'SPCT_SUB_DICTATION',
    'SPEI_SOUND_START', 'eLEXTYPE_PRIVATE1',
    'SSSPTRelativeToCurrentPosition',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SGRsItem',
    'SPLEXICONTYPE', 'SpInProcRecoContext',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SVEStreamEnd',
    'STCRemoteServer', 'SPCT_SUB_COMMAND', 'DISPID_SRGDictationLoad',
    'DISPID_SPPsCount', 'SPCT_SLEEP',
    'DISPID_SRCAudioInInterferenceStatus', 'SPEI_END_SR_STREAM',
    'SRSInactiveWithPurge', 'ISpSerializeState',
    'DISPID_SVSLastResult', 'SREHypothesis', 'SP_VISEME_7',
    'SGDSActive', 'DISPID_SPPNumberOfElements',
    'SpeechPropertyResourceUsage', 'SPDATAKEYLOCATION', 'SPEVENTENUM',
    'SAFT32kHz8BitStereo', 'eLEXTYPE_RESERVED9', 'STSF_AppData',
    'DISPID_SVDisplayUI', 'DISPID_SPELexicalForm', 'SGSExclusive',
    'DISPID_SPARecoResult', 'SpeechRecoProfileProperties',
    'SPPS_NotOverriden', 'eLEXTYPE_PRIVATE13', 'SP_VISEME_3',
    'SVP_18', 'Speech_StreamPos_RealTime', 'DISPID_SGRSTsCount',
    'SpeechRecoEvents', 'SREBookmark', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SPEAudioTimeOffset', 'SRAInterpreter', 'SPEI_SOUND_END',
    'SPWAVEFORMATTYPE'
]
